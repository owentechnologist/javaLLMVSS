...
public class EmbedNamedRedisHashAttributeAsVector {
    ...
    public static void main(String[] args)throws Throwable{
        ...
        System.out.println("connection is: "+jedis+"  "+jedis.ping());
        Scanner in  = new Scanner(System.in);
        String hash_key_name = "zoo:animal:11"; //zoo:animal:57 zoo:animal:31 zoo:animal:22
        String hash_attribute_name = "biography";
        System.out.println("Please enter the redis key-name of the hash record you wish to target for vector embedding ["+hash_key_name+"]  :");
        ...
        hash_attribute_name = in.nextLine().trim();
        System.out.println("Fetching value for hash : "+hash_key_name+"  attribute : "+hash_attribute_name);
