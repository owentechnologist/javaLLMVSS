 ...
 *  mvn compile exec:java -Dexec.cleanupDaemonThreads=false -Dexec.args="-h redis-12000.homelab.local -p 12000 -s p@ssword333 -vsssemanticcache"
 **/

public class VSSSemanticCachedLLMExchange {
    ...
    public static void main(String[] args){
        ...
        VSSSemanticCachedLLMExchange vssSemanticCachedLLMExchange = new VSSSemanticCachedLLMExchange();
        String userResponse = "";
